...
fun strassenWinogradStep(A: Array<DoubleArray>, B: Array<DoubleArray>, C: Array<DoubleArray>, size: Int, minSize: Int) {
    if (size <= minSize) {
...
fun algStrassenWinograd(A: Array<DoubleArray>, B: Array<DoubleArray>, C: Array<DoubleArray>, N: Int, P: Int, M: Int) {
    var maxSize = max(N, P)
